...
public class NomalConversation extends Conversation {
  ...
  public void setProfile(TIMUserProfile profile){
    ...
    public void navToDetail(Context context) {
        ChatActivity.navToChat(context,identify, TIMConversationType.C2C,faceUrl,nickName);
    }
    ...
    SDKmanager.searchUserProfile(this.identify, new TIMValueCallBack<TIMUserProfile>() {
        ...
        public void onSuccess(TIMUserProfile arg0) {
            ...
            Glide.with(context).load(faceUrl).diskCacheStrategy(DiskCacheStrategy.SOURCE).into(imageview);
     ...
     */
        ...
        long i=conversation.getUnreadMessageNum();
        if(i<0)i=0;
