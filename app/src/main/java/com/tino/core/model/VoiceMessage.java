...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.MViewHolder viewHolder, Context context) {
        LinearLayout linearLayout = new LinearLayout(TinoApplication.getContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(TinoApplication.getContext());
    ...
    public String getSummary() {
        return TinoApplication.getContext().getString(R.string.summary_voice);
    }
