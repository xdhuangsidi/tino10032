...
public abstract class Conversation implements Comparable {
    ...
    public void setCv(ConversationView cv) {
        this.cv = cv;
    }

    abstract public void setAvatarAndUsername(final Context context, final TextView tvName, final CircleImageView imageview);
    /**
     * 获取最后一条消息的时间
     */
