...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth =2;// a.getDimensionPixelSize(0, 0);
        this.mBorderColor = Color.WHITE;//a.getColor(1, -16777216);
        this.mBorderOverlay = true;//a.getBoolean(2, false);
        a.recycle();
        init();
    }
    ...
    private Bitmap getBitmapFromDrawable(Drawable drawable) {
        ...
        try {
            ...
            if (drawable instanceof ColorDrawable) {
                ...
                bitmap = Bitmap.createBitmap(DensityUtil.dip2px(getContext(), 40.0f), DensityUtil.dip2px(getContext(), 40.0f), BITMAP_CONFIG);
            } else {
