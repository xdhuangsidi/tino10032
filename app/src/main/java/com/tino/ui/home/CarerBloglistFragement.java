...
public class CarerBloglistFragement extends BaseRecyclerFragment<Blog> {
    ...
    public void toRefresh() {
        ...
        AccountImpl.getCareBlogtList(CommonUtils.gettoken(),CommonUtils.getUid(),0,this);

    }
    public void toLoadMore() {
        super.toLoadMore();
        AccountImpl.getCareBlogtList(CommonUtils.gettoken(),CommonUtils.getUid(),this.currentPage+8,this);
