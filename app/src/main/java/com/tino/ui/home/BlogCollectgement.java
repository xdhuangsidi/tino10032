...
public class BlogCollectgement extends BaseRecyclerFragment<Blog>  {
    ...
    public void toRefresh() {
        ...
        AccountImpl.getCollectBlogtList("",((UserDetialActivity)getActivity()).user.getUserId(), 0, this);
    }

    public void toLoadMore() {
        super.toLoadMore();

        AccountImpl.getCollectBlogtList("",((UserDetialActivity)getActivity()).user.getUserId(),currentPage+8,this);
