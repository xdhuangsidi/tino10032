...
import com.tino.adapter.CommonHolder;
...
public class BLogsAdapter extends BaseRecyclerAdapter<Blog> {
                 ...
                 if("2".equals(blog.getTopic().getTopicTime())){
                    StringFormatUtil spanStr = new StringFormatUtil(context, wholeStr,
                     ...
                     tv_topic.setOnClickListener(new View.OnClickListener() {
                         ...
                         public void onClick(View view) {
                             TopicActivity.navToChat(context,"https://139.199.21.36/H23/topic2.jpg",
                                     "2");
                         }
                     });
                 }else{
                    ...
                    tv_topic.setText(spanStr.getResult());
                     tv_topic.setOnClickListener(new View.OnClickListener() {
                         @Override
                         public void onClick(View view) {
                             TopicActivity.navToChat(context,"https://139.199.21.36/H23/topic1.jpg",
                                     "3");
                         }
                     });
                 }
...
*/
            ...
            if(list==null||list.size()==0){
                ...
                this.photo_gridview.setOnTouchBlankPositionListener(new NoScrollGridView.OnTouchBlankPositionListener(){
