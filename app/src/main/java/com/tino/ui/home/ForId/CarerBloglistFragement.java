...
public class CarerBloglistFragement extends BaseRecyclerFragment<Blog> {
    ...
    public void toRefresh() {
        ...
        AccountImpl.getCareBlogtList("",((UserDetialFromIdActivity)getActivity()).user.getUserId(),0,this);

    }
    public void toLoadMore() {
        super.toLoadMore();
        AccountImpl.getCareBlogtList("",((UserDetialFromIdActivity)getActivity()).user.getUserId(),this.currentPage+8,this);
