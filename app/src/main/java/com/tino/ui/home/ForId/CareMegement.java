...
public class CareMegement extends BaseRecyclerFragment<User> {
    ...
    public void toRefresh() {
        ...
        currentPage=0;
        AccountImpl.getCareME("",((UserDetialFromIdActivity)getActivity()).user.getUserId(),0,this);

    }
    public void toLoadMore() {
        super.toLoadMore();
        AccountImpl.getCareME("",((UserDetialFromIdActivity)getActivity()).user.getUserId(),currentPage+8,this);
