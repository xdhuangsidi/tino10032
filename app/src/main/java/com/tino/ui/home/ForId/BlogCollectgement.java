...
public class BlogCollectgement extends BaseRecyclerFragment<Blog> {
    ...
    public void toRefresh() {
        ...
        AccountImpl.getCollectBlogtList("",((UserDetialFromIdActivity)getActivity()).user.getUserId(), 0, this);
    }

    public void toLoadMore() {
        super.toLoadMore();

        AccountImpl.getCollectBlogtList("",((UserDetialFromIdActivity)getActivity()).user.getUserId(),currentPage+8,this);
