...
public class CareMegement extends BaseRecyclerFragment<User> {
    ...
    public void toRefresh() {
        ...
        currentPage=0;
        AccountImpl.getCareME("",((UserDetialActivity)getActivity()).user.getUserId(),0,this);

    }
    public void toLoadMore() {
        super.toLoadMore();
        AccountImpl.getCareME("",((UserDetialActivity)getActivity()).user.getUserId(),currentPage+8,this);
