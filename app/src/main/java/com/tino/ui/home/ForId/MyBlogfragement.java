...
public class MyBlogfragement extends BaseRecyclerFragment<Blog> {
    ...
    public void toRefresh() {
        ...
        currentPage=0;
        AccountImpl.getMyBlogtList("",((UserDetialFromIdActivity)getActivity()).user.getUserId(), 0,this);

    }
    public void toLoadMore() {
        super.toLoadMore();
        AccountImpl.getMyBlogtList("",((UserDetialFromIdActivity)getActivity()).user.getUserId(),currentPage+8,this);
