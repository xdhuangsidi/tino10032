...
public class CustomChatActivity extends FragmentActivity implements ChatView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomChatAdapter(this,faceUrl,messageList);
        ...
        switch (type) {
            case C2C:{
                    ...
                    if(TextUtils.isEmpty(username))title.setTitleText(titleStr =identify);
                    else title.setTitleText(titleStr = username);//需要优化  intent加入聊天者昵称
                }
                break;
        ...
        if (message == null||message.isSelf()) {
            ...
            if (mMessage != null) {
                if (mMessage instanceof CustomMessage){
                    ...
                    ((CustomMessage) mMessage).avatarurl=faceUrl;
                    ((CustomMessage) mMessage).username=username;
