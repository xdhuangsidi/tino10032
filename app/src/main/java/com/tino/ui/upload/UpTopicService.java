...
public class UpTopicService extends Service {
    @Nullable
            ...
            public void run() {
                for (String pic : picPaths) {
                    ...
                    try {
                        ...
                        UpTopicService.this.stopSelf();
                        Toast.makeText(UpTopicService.this, "文件不存在", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
                }
                            ...
                            UploadImp.SaveImageInCosServer(sig, PhotoUtil.bitmapTobyte(picPaths.get(position)), tempurl + name, new ActionCallback<String>() {
                                ...
                                public void onSuccess(String s) {
                                    ...
                                    if (keyMap.size() >= picPaths.size()) {
                                        ...
                                        UploadImp.uploadTopicblog(token, id, "",title, text, jsonArray.toJSONString(), new ActionCallback<String>() {
                                            @Override
                                            public void inProgress(float f) {
                                            ...
                                            @Override
                                            public void onSuccess(String s) {
                                                Toast.makeText(UpTopicService.this, "恭喜,发布成功!^_^", Toast.LENGTH_SHORT).show();
