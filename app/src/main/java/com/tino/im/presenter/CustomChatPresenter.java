 ...
 * 聊天界面逻辑
 */
public class CustomChatPresenter implements Observer {
    ...
    public CustomChatPresenter(ChatView view, String identify, TIMConversationType type){
        this.view = view;
    ...
    public void sendMessage(final TIMMessage message) {
        conversation.sendMessage(message, new TIMValueCallBack<TIMMessage>() {
            ...
            public void onError(int code, String desc) {//发送消息失败
                ...
                Toast.makeText(TinoApplication.getContext(), "send fial"+desc, Toast.LENGTH_SHORT).show();
            }
    ...
    public void sendOnlineMessage(final TIMMessage message){
        conversation.sendOnlineMessage(message, new TIMValueCallBack<TIMMessage>() {
            ...
            public void onError(int i, String s) {
                ...
                Toast.makeText(TinoApplication.getContext(), "send fial"+s, Toast.LENGTH_SHORT).show();
            }
